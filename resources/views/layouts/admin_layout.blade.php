  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/admin_panel" class="nav-link">Главная</a>
      </li>
      <!-- <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">Быстрые ссылки</li>
          <li class="nav-item">
            <a href="{{ route('articles.index') }}" class="nav-link">Слайдер </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('routes.index') }}" class="nav-link">Маршрут </a>
          </li>
          <li class="nav-item">
           <a href="{{ route('agencies.index') }}" class="nav-link">Агенства </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('categories.index') }}" class="nav-link">Категории </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('organisations.index') }}" class="nav-link">Организации </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('places.index') }}" class="nav-link">Места/Объекты </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('attributes.index') }}" class="nav-link">Атрибуты </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('locations.index') }}" class="nav-link">Расположения </a>
          </li>
