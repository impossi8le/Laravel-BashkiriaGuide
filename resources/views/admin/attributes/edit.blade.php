...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Редактировать атрибут: Название - {{ $attribute['name'] }}</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
                ...
                @method('PUT')
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $attribute['name'] }}" name="heading" class="form-control" id="exampleInputhead1" placeholder="Введите заголовок" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      @if($attribute['img'])
                          <div class="form-group">                            
                              <img src="/storage/{{$attribute['img']}}" alt="Image" class="img-thumbnail">
                          </div>
                      @endif
                    </div>
